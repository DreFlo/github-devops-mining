...
class MongoDBWrapper:
    ...
    def has_been_processed(self, repo_name : str):
        return self.db['repo_tools_history'].find_one({"repo_full_name": repo_name}) is not None or self.db_2['repo_tools_history'].find_one({"repo_full_name": repo_name}) is not None
